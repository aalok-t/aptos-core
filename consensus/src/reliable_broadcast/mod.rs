...
where
    M: Clone,
{
    pub fn new(validators: Vec<Author>, network_sender: Arc<dyn RBNetworkSender<M> + Send + Sync>) -> Self {
        Self {
            validators,
            network_sender,
        }
